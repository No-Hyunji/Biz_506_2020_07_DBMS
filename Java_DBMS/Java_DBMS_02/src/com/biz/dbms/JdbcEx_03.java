...
public class JdbcEx_03 {
	...
	public static void main(String[] args) {
		/*
		 * UPDATE구현 1. 전체(검색조건에 맞는) 데이터 리스트를 보여주고 2. 내용을 변경할 데이터의 seq값을 키보드에서 입력받고 2.
		 * 데이터를 1개 SELECT하고 4. 각 칼럼데이터를 보여주고 5. 변경할 내용을 입력받는다 6. 완료되면 UPDATE method를
		 * 호출하여 변경을 실시
		 * 
		 */
		...
		System.out.printf("변경할 고객번호( %s ,Enter:변경안함) >>", orderVO.getO_pcode());
